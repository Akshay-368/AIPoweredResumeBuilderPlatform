...
namespace ResumeAI.ATSScore.API.Migrations
{
    ...
    [Migration("20260415110000_AddNotificationsAndFeedback")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResumeAI.ATSScore.API.Persistence.UserResumePreferenceEntity", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("DefaultResumeRefId")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("default_resume_ref_id");

                    b.Property<string>("DefaultResumeRefType")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("default_resume_ref_type");
                    ...
                    b.ToTable("user_resume_preferences", "projects");
                });

            modelBuilder.Entity("ResumeAI.ATSScore.API.Persistence.FeedbackEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("feedback", "projects");
                });

            modelBuilder.Entity("ResumeAI.ATSScore.API.Persistence.NotificationEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("notifications", "projects");
                });

            modelBuilder.Entity("ResumeAI.ATSScore.API.Persistence.NotificationUserStateEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("IsDeletedForUser")
                        .HasColumnType("boolean")
                        .HasColumnName("is_deleted_for_user");
                    ...
                    b.ToTable("notification_user_states", "projects");
                });
            ...
            modelBuilder.Entity("ResumeAI.ATSScore.API.Persistence.NotificationEntity", b =>
                {
                    b.HasMany("ResumeAI.ATSScore.API.Persistence.NotificationUserStateEntity", "UserStates");
                });

            modelBuilder.Entity("ResumeAI.ATSScore.API.Persistence.NotificationUserStateEntity", b =>
                {
                    b.HasOne("ResumeAI.ATSScore.API.Persistence.NotificationEntity", "Notification")
                        .WithMany("UserStates")
